...
function setup() 
{
  ...
  star1 = createSprite(325,70,50,50);
  star1.addImage(starImage);
  star1.scale = 0.02;

  star2 = createSprite(125,350,50,50);
  star2.addImage(starImage);
  star2.scale = 0.02;

  blower = createImg('baloon2.png');
  blower.position(275,350);
  blower.size(100,100);
  ...
  score = createSprite(50,25,50,50);
  score.addAnimation('empty',empty);
  score.addAnimation('half',oneStar);
  score.addAnimation('full',full);
